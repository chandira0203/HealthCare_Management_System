...
$dt = date("Y-m-d");
$tim = date("H:i:s");
$_SESSION['currency'] = "RM ";
include("dbconnection.php");
?>
<!DOCTYPE html >
<html >
<head>
<title>Multi-Speciality Hospital</title>
...
if(!isset($_SESSION['patientid']))
{
    if(!isset($_SESSION['doctorid']))
    {
        ...
        {
?>      <li><a href="patient.php" <?php if(basename($_SERVER['PHP_SELF']) == "patient.php"){ echo ' class="active"'; } ?>> New Patient - Registration</a></li>
        ...
        <li><a href="patientlogin.php" <?php if(basename($_SERVER['PHP_SELF']) == "patientlogin.php"){ echo ' class="active"'; } ?>>Patient Login (already Registered)</a></li>        
