  ...
  <div id="container">
    ...
    <table width="200" border="3">
      <tbody>
        ...
        <tr>
          <td height="36" colspan="2" align="center"><strong><br>
              <a href="patient.php">New user Click Here to Register</a>  </strong> | <a href="patientforgotpassword.php"><strong>Forgot Password</strong></a></td>
        </tr>
      </tbody>
    </table>
    </form>
